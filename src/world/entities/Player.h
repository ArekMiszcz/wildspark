...
class Player {
public:
    Player(const std::string& id = "local_player", sf::Color color = sf::Color::Green);
    ...
    float getSpeed() const { return m_speed; } // Assuming a constant speed for now, can be made variable

    void setTargetDirection(const sf::Vector2f& direction); // Added
...
private:
    ...
    static std::string m_localPlayerId; // Declaration of static member
