...
class MockSession : public Nakama::NSessionInterface {
 public:
  ...
  MOCK_METHOD(bool, isRefreshExpired, (Nakama::NTimestamp now),
              (const, override));
  ...
  MOCK_METHOD(std::string, getVariable, (const std::string& name),
              (const, override));
};
...
class MockRtClientListener : public Nakama::NRtClientListenerInterface {
 public:
  ...
  MOCK_METHOD(void, onDisconnect, (const Nakama::NRtClientDisconnectInfo& info),
              (override));
  MOCK_METHOD(void, onError, (const Nakama::NRtError& error), (override));
  MOCK_METHOD(void, onChannelMessage, (const Nakama::NChannelMessage& message),
              (override));
  MOCK_METHOD(void, onChannelPresence,
              (const Nakama::NChannelPresenceEvent& presence), (override));
  MOCK_METHOD(void, onMatchmakerMatched,
              (Nakama::NMatchmakerMatchedPtr matched), (override));
  MOCK_METHOD(void, onMatchData, (const Nakama::NMatchData& matchData),
              (override));
  MOCK_METHOD(void, onMatchPresence,
              (const Nakama::NMatchPresenceEvent& matchPresence), (override));
  MOCK_METHOD(void, onNotifications,
              (const Nakama::NNotificationList& notifications), (override));
  MOCK_METHOD(void, onParty, (const Nakama::NParty& party), (override));
  MOCK_METHOD(void, onPartyClosed, (const Nakama::NPartyClose& partyCloseEvent),
              (override));
  MOCK_METHOD(void, onPartyData, (const Nakama::NPartyData& partyData),
              (override));
  MOCK_METHOD(void, onPartyJoinRequest,
              (const Nakama::NPartyJoinRequest& partyJoinRequest), (override));
  MOCK_METHOD(void, onPartyLeader, (const Nakama::NPartyLeader& partyLeader),
              (override));
  MOCK_METHOD(void, onPartyMatchmakerTicket,
              (const Nakama::NPartyMatchmakerTicket& ticket), (override));
  MOCK_METHOD(void, onPartyPresence,
              (const Nakama::NPartyPresenceEvent& presenceEvent), (override));
  MOCK_METHOD(void, onStatusPresence,
              (const Nakama::NStatusPresenceEvent& presence), (override));
  MOCK_METHOD(void, onStreamData, (const Nakama::NStreamData& data),
              (override));
  MOCK_METHOD(void, onStreamPresence,
              (const Nakama::NStreamPresenceEvent& presence), (override));
};

class TestableNetworking : public Networking {
 public:
  explicit TestableNetworking(Nakama::NClientPtr nakamaClientPtr)
      : Networking(nakamaClientPtr) {}

  InternalRtListener* getInternalListener() { return m_listener.get(); }

  Nakama::NRtClientPtr getProtectedRtClient() { return m_rtClient; }
  void setProtectedRtClient(Nakama::NRtClientPtr client) {
    m_rtClient = client;
  }

  std::string getPendingMatchId() const { return m_pendingMatchId; }

  void callCompletePendingMatchJoin() { completePendingMatchJoin(); }
...
TEST(NetworkingTest, InitializeNetworking) {
  ...
  EXPECT_CALL(*mockSession, getUserId())
      .WillRepeatedly(testing::ReturnRef(userIdStr));
...
TEST(NetworkingTest, ListMatchesSuccess) {
  ...
  EXPECT_CALL(*mockNClient, listMatches(testing::_, testing::_, testing::_,
  ...
  networking.listMatches(
      [&callbackCalled,
       &match_item](const std::vector<Nakama::NMatch>& matches_vec) {
        callbackCalled = true;
  ...
  EXPECT_CALL(*mockNClient, listMatches(testing::_, testing::_, testing::_,
      ...
      .WillOnce(testing::Invoke(
          [](Nakama::NSessionPtr /*session*/,
            ...
            errorCallback(
                Nakama::NError("Simulated error", Nakama::ErrorCode::Unknown));
          }));
...
TEST(NetworkingTest, JoinMatchWhenNotConnected) {
  ...
  EXPECT_CALL(*mockSession, getUserId())
      .WillRepeatedly(testing::ReturnRef(userIdStr));
  EXPECT_CALL(*mockNClient, createRtClient())
      .WillOnce(testing::Return(mockRtClient));
  EXPECT_CALL(*mockRtClient, connect(testing::_, testing::Eq(true), testing::_))
      .Times(1);
  EXPECT_CALL(*mockRtClient,
              joinMatch(testing::_, testing::_, testing::_, testing::_))
      .Times(0);
  ...
  EXPECT_CALL(*mockRtClient, isConnected())
      .WillRepeatedly(testing::Return(true));
  EXPECT_CALL(*mockRtClient,
              joinMatch(matchId, testing::_, testing::_, testing::_))
      .WillOnce(testing::Invoke(
          [&joinedMatchData](
...
TEST(NetworkingTest, SendPlayerUpdate) {
  ...
  EXPECT_CALL(*mockSession, getUserId())
      .WillRepeatedly(testing::ReturnRef(userId));
  EXPECT_CALL(*mockRtClient, isConnected())
  ...
  EXPECT_CALL(*mockRtClient, sendMatchData(matchId, 1, testing::_, testing::_))
      .Times(1);
...
TEST(NetworkingTest, SendPlayerUpdateNotConnected) {
  ...
  EXPECT_CALL(*mockRtClient,
              sendMatchData(testing::_, testing::_, testing::_, testing::_))
      .Times(0);
